const WORDS = [
  "LOVE", "BOOK", "HAND", "TREE", "DOOR", "BALL", "WIND", "MILK", "SNOW", "JUMP",
  "WALK", "TALK", "SPIN", "READ", "RING", "PLAY", "GAME", "FAST", "SLOW", "HIGH",
  "COLD", "WARM", "BLUE", "GOLD", "FIRE", "STAR", "ROCK", "SAND", "MOON", "RAIN",
  "LEAF", "FISH", "BIRD", "BEAR", "LION", "FROG", "WOLF", "CRAB", "ANTS", "TREE",
  "ROOT", "BARK", "SOIL", "RICE", "CORN", "MEAT", "SOUP", "SALT", "CAKE", "MILK",
  "IRON", "WOOD", "TOOL", "NAIL", "WIRE", "BOLT", "ROAD", "PATH", "SHIP", "BIKE",
  "TAXI", "DOOR", "ROOM", "WALL", "ROOF", "BATH", "SINK", "OVEN", "COOK", "WASH",
  "HEAD", "HAIR", "EYES", "NOSE", "LIPS", "NECK", "BACK", "ARMS", "LEGS", "FEET",
  "TOES", "SKIN", "HURT", "HEAL", "REST", "PAIN", "LOVE", "HATE", "KIND", "NICE",
  "MEAN", "CALM", "BUSY", "RICH", "POOR", "FULL", "HALF", "OPEN", "SHUT", "TIME"
];
...
function outputMsg(isCorrectGuess, userInput, wordToGuess) {
  isCorrectGuess ? oneOfrigthAnswer(userInput, wordToGuess) : wrongAnswer(userInput);
}
...
function remainingLifeMsg(numberOfLifes, deaths) {
  const commentOnLifes = (numberOfLifes - deaths) < deaths ? 'You are about to die spend you time wisely' : 'Relax you have enough lives';
  const msg = `
